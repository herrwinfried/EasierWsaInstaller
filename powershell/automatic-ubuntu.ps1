...
Clear-Host
    ...
    if ($wsaint -and $gappsint -and $wsatoolsint) {
        wsl -d ubuntu -e sudo sh -c "cd ~ && sudo apt update && sudo apt upgrade -y && sudo apt install -y unzip lzip && wget https://raw.githubusercontent.com/herrwinfried/wsa-script/1.0.1/setup-arm.sh -O setup-arm.sh && sudo chmod +x ./setup-arm.sh && sudo ./setup-arm.sh --wsa --gapps --wsatools --all-okey"
    }
    if ($wsaint -and $gappsint) {
    ...
    elseif ($wsaint -and $wsatoolsint)
    {
        wsl -d ubuntu -e sudo sh -c "cd ~ && sudo apt update && sudo apt upgrade -y && sudo apt install -y unzip lzip && wget https://raw.githubusercontent.com/herrwinfried/wsa-script/1.0.1/setup-arm.sh -O setup-arm.sh && sudo chmod +x ./setup-arm.sh && sudo ./setup-arm.sh --wsa --wsatools --all-okey"
    }
    elseif ($wsaint)
    {
    ...
    elseif ($gappsint -and $wsatoolsint)
    {
        wsl -d ubuntu -e sudo sh -c "cd ~ && sudo apt update && sudo apt upgrade -y && sudo apt install -y unzip lzip && wget https://raw.githubusercontent.com/herrwinfried/wsa-script/1.0.1/setup-arm.sh -O setup-arm.sh && sudo chmod +x ./setup-arm.sh && sudo ./setup-arm.sh --gapps --wsatools --all-okey"
    }
    elseif ($gappsint)
    {
    ...
    elseif (! $wsaint -or !$gappsint -and $wsatoolsint )
    {
        ...
        Pause
        Clear-Host
        wsl -d ubuntu -e sudo sh -c "cd ~ && sudo apt update && sudo apt upgrade -y && sudo apt install -y unzip lzip && wget https://raw.githubusercontent.com/herrwinfried/wsa-script/1.0.1/setup-arm.sh -O setup-arm.sh && sudo chmod +x ./setup-arm.sh && sudo ./setup-arm.sh --wsatools --all-okey"
    }
    elseif (! $wsaint -or !$gappsint )
    {
        Write-Host "Make sure you have Ubuntu(ubuntu without version number) installed or it could cause problems if things go wrong. If not, please close the window directly."
