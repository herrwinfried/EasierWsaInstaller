...
wget https://raw.githubusercontent.com/herrwinfried/wsa-script/1.1.0/python/wsatools.py -O wsatools.py
echo "$green WSATools Beginning to download. $yellow"

wget https://raw.githubusercontent.com/herrwinfried/wsa-script/1.1.0/powershell/wsatools.ps1 -O wsatools.ps1
...
wget https://raw.githubusercontent.com/herrwinfried/wsa-script/1.1.0/python/wsa.py -O wsa.py
...
function opengapps {
    ...
    pip_install
    if [[ -x "$(command -v python3.9)" ]] && [[ -x "$(command -v pip3)" ]]; then
wget https://raw.githubusercontent.com/herrwinfried/wsa-script/1.1.0/python/opengapps.py -O opengapps.py
#
...
wget https://raw.githubusercontent.com/herrwinfried/wsa-script/1.1.0/powershell/Setup.ps1 -O Setup.ps1
