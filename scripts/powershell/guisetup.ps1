...
if ( $wsldistro -eq "Ubuntu") {
    $wslprep = "cd ~; sudo rm -rf  /root/easierwsainstaller ; sudo rm -rf  /root/easierwsainstaller-project ; sudo apt update && sudo apt upgrade -y; sudo apt install -y git curl wget; cd /root/; git clone -b 2.0.1 https://github.com/herrwinfried/easierwsainstaller.git ; cd easierwsainstaller; cd scripts; cd bash; chmod +x ./*.sh "
}

elseif ( $wsldistro -eq "openSUSE-Tumbleweed") {
    $wslprep = "cd ~; sudo rm -rf  /root/easierwsainstaller ; sudo rm -rf  /root/easierwsainstaller-project ; sudo zypper dup -y; sudo zypper install -y git curl wget; cd /root/; git clone -b 2.0.1 https://github.com/herrwinfried/easierwsainstaller.git ; cd easierwsainstaller; cd scripts; cd bash; chmod +x ./*.sh "
...
elseif ( $wsldistro -eq "Debian") {
    ...
    $wslprep = "cd ~; sudo rm -rf  /root/easierwsainstaller ; sudo rm -rf  /root/easierwsainstaller-project ; cd /root/; git clone -b 2.0.1 https://github.com/herrwinfried/easierwsainstaller.git ; cd easierwsainstaller; cd scripts; cd bash; chmod +x ./*.sh "
}
if ($arch -eq "arm64") {
